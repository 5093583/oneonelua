...
appdf.HTTP_URLS = {
    "http://testc.oneone.im",                                                    --本地
    "http://testc.oneone.im",                                                         --测试
    "http://rnsc.degemesse.com",                                                         --线上
}

appdf.SERVER_LIST = {
    "testc.oneone.im",                                                                --本地
    "127.0.0.1",                                                               --测试
    "rnsc.degemesse.com",                                                            --线上
}
...
function appdf.utf8tounicode(convertStr)
...
-- function appdf.utf8_to_unicode(convertStr)
-- return convertStr
