...
appdf.GAME_SRC                              = "game."
--扩展目录
appdf.EXTERNAL_SRC							= "client.client.src.external."
--通用定义目录
appdf.HEADER_SRC							= "client.client.src.header."
--私人房目录
appdf.PRIVATE_SRC                           = "client.client.src.privatemode."
...
--环境
appdf.ENV                                   = 3                                     --(1.本地 2.测试 3.线上)

appdf.HTTP_URLS = {
    "http://192.168.2.212",                                                    --本地
    "http://m.game316.com",                                                         --测试
    "http://47.94.251.86:8090",                                                         --线上
}
