...
yl.FRIENDPORT							= 8630 --@friend_port
--编译码
yl.VALIDATE 							= "0745B502-E461-4ECE-8F4C-CCF7DB3B8FC7" --@compilation

--http请求链接地址
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
--yl.HTTP_URL								= "http://ry.webfox.com" --@http_url
yl.HTTP_URL								= appdf.HTTP_URL --@http_url
...
--客服QQ
yl.SERVICE_QQ                           = 398472227
--客服电话
yl.SERVICE_PHONE                        = 18073729152
...
yl.SocialShare =
{
	...
	url 								= yl.HTTP_URL,
	AppKey							 	= "591d0945a40fa32e1e001606", --@share_appkey_social
}
...
yl.WeChat = 
{
	AppID 								= "wx788b6dfce651fe0e", --@wechat_appid_wx
	AppSecret 							= "dd00f97166ae04474b39fc19cd328abc", --@wechat_secret_wx
	-- 商户id
	PartnerID 							= "1496696372", --@wechat_partnerid_wx
	-- 支付密钥					        
	PayKey 								= "6dedf33af6a6fb613be518168354947d", --@wechat_paykey_wx
	URL 								= yl.HTTP_URL,
}
...
{
	-- 合作者身份id
	PartnerID							= "2018011001742338", --@alipay_partnerid_zfb
	-- 收款支付宝账号						
	SellerID							= "742678896@qq.com", --@alipay_sellerid_zfb
	-- rsa密钥
	RsaKey								= "", --@alipay_rsa_zfb
	NotifyURL							= yl.HTTP_URL .. "/Pay/ZFB/notify_url.aspx",
	-- ios支付宝Schemes
	AliSchemes							= "game316ali", --@alipay_schemes_zfb
}
...
yl.ClientScene = nil -- 保存 ClientScene 的引用 