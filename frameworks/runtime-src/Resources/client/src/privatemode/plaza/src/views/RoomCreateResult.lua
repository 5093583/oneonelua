...
function RoomCreateResult:ctor( scene )
    ...
    local rootLayer, csbNode = ExternalFun.loadRootCSB("CreateRoomResult/CreateRoomResult.csb", self)
    ...
    print("房间 " .. PriRoom:getInstance().m_tabPriData.szServerID .. " 创建成功, 是否进入游戏?")
    -- 加入游戏
